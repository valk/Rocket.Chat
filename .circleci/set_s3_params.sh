# Assuming we are credentialed as circleci-rocketchat, assume the role rockechat-deploy.
# This overwrites our AWS_* credentials.
# Also, define variables for use in uploading tarballs to S3.
